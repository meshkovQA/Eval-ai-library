...
_LAZY = {
    ...
    "OpenAIResponsesTraceCollector":  (".openai_responses_callback",  ["openai"]),
    "trace_openai_client":            (".openai_responses_callback",  ["openai"]),
    "EvalLibSpanExporter":            (".otel_collector",         ["opentelemetry"]),
    "CrewAITraceCollector":           (".crewai_callback",        ["crewai"]),
    "install_crewai_tracing":         (".crewai_callback",        ["crewai"]),
    "smolagents_step_callback":       (".smolagents_callback",    ["smolagents"]),
    "install_smolagents_tracing":     (".smolagents_callback",    ["smolagents"]),
    ...
    "AutoGenTraceHandler":            (".autogen_callback",       ["autogen_core"]),
    "TracedChatCompletionClient":     (".autogen_callback",       ["autogen_core"]),
    "install_sk_tracing":             (".semantic_kernel_callback", ["semantic_kernel"]),
    "trace_chat_completion":          (".semantic_kernel_callback", ["semantic_kernel"]),
    "build_sk_filters":               (".semantic_kernel_callback", ["semantic_kernel"]),
    "install_haystack_tracing":       (".haystack_callback",      ["haystack"]),
    "EvalLibHaystackTracer":          (".haystack_callback",      ["haystack"]),
    "PhidataTraceCollector":          (".phidata_callback",       ["agno", "phi"]),
    "AgnoTraceCollector":             (".phidata_callback",       ["agno", "phi"]),
}
